...
const [] = useState("")
          ...
          return (
              <div className={props.classValue}>
               ...
               <> <Range type={`${props.type}DepartureHour`} begin='0:00' end='24:00' add=':00' min='0' max='24'></Range></>
                </div>
                ...
                <><Range type={`${props.type}ArrivalHour`} begin='0:00' end='24:00' add=':00' min='0' max='24'></Range></>
                </div>
              </div>
          )    
        }
